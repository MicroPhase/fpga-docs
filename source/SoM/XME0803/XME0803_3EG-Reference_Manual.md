# **XME0803(3EG) Reference Manual**

[[中文]](https://microphase-doc.readthedocs.io/zh-cn/latest/SoM/XME0803/XME0803_3EG-Reference_Manual.html)
...
XME0803(3EG) is a industrial-grade system module based on Xilinx Zynq UltraScale+   SoC from Microphase Technology. With customizable variants available upon request, customised requirements may be subject to minimum order quantities,  please contact our sales team for more information: [sales@microphase.cn](sales@microphase.cn).  
...
The core board features 168 single-ended IOs (configurable as 84 differential pairs), adjustable IO voltages, 4 PS-GTR high-speed RX/TX pairs,  and equal-length differential alignments with 50-ohm single-ended and 100-ohm differential impedance.**(3EG does not have a GTH transceiver)**

### ○Board Layout

![](./XME0803-Reference_Manual.assets/1.JPG)
...
The JTAG signal link of the XME0803(3EG) is connected to the expansion connector.
...
The XME0803(3EG) core board provides a 33.3Mhz active clock for the PS system, a 200Mhz active clock for the PL system.  
...
**Please note that the power input of XME0803(3EG) is +5V. We recommend using a 5V/2A power supply.**  

### ○LED  

The XME0803(3EG) board provides two LEDs, the power indicator and the FPGA configuration status light.
...
The XME0803(3EG) uses three sets of connectors, JM1, JM3 and JM4, for the FPGA IO signals and Ethernet interface.  
